...
export class ScreenshotController {
    ...
    async start(): Promise<void> {
        ...
        setProcessing(true);
        updateButtonsState();
        setStatus('Захват экрана...', 'processing');
        showAnswer('');
        showStopButton();
        ...
        try {
            ...
            const label = `[Скриншот сделан ${timestamp}]`;
            showText(label);

            setStatus('Анализ скриншота...', 'processing');
            ...
            if (answerText) {
                ...
                showAnswer('Ничего полезного не найдено.');
            }
